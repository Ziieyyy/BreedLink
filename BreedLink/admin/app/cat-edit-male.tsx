...
export default function EditMaleCatScreen() {
  ...
  // ✅ Fetch existing male cat data
  useEffect(() => {
    if (!cat_id) return;

    const fetchCatData = async () => {
      const id = Array.isArray(cat_id) ? cat_id[0] : cat_id;
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Edit Male Cat</Text>

  ...
  const saveCatProfile = async () => {
    try {
      ...
      if (insertError) {
        ...
        showCustomAlert('Error', `Failed to create cat profile: ${insertError.message}`, 'error');
        return;
      }

      showCustomAlert('Success', '✅ Your cat profile has been created successfully!', 'success');
    } catch (error) {

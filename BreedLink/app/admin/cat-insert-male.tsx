...
export default function InsertMaleCatScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from("male_cats").insert([
        {
      ...
      Alert.alert("Success", "Male cat added successfully!", [
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Add Male Cat</Text>
